...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForInBook() {
    ...
    b.property("year", 0x1a03dc0acd30fc3aL).type(PrimitiveTypeId.INTEGER).origin("1874583808866581562").done();
  ...
  private static ConceptDescriptor createDescriptorForReferenceType() {
    ...
    b.version(2);
    b.property("serNumber", 0x1159e6fb6e9e4ecbL).type(PrimitiveTypeId.INTEGER).origin("1250284339139071691").done();
    return b.create();
  }
}
